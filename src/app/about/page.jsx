      ...
      <div className={styles.container}>
        <div className={styles.aboutContainer}>
          ...
          <p className={styles.storyText}>
            ...
            იყვნენ, ზრუნავდნენ სკებზე და იღებდნენ თაფლს. თუმცა, ეს საგვარეულო
            ...
            თაფლის სამშობლოცაა, ჩვენს ქვეყანაში აღმოჩენილია უძველესი თაფლის
            ნმუშები.
          </p>
          <br />
          <p className={styles.storyText}>
            ამ პრობლემების გათვალისწინებით და ჩვენს გარემოცვაში მიმდინარე
            მოვლენებიდან გამომდინარე გადავწყვითეთ ამ პრობლემას ჩავღრმავებოდით და
            გავესაუბრეთ მეფუტკრეებს, ვესაუბრეთ მიზეზებზე თუ რატომ არ იყო
            მეფუტკრეობა დღესდღეისობით მყარი და შემოსავლიანი პროფესია და
            გამოვავლინეთ პრობლემები. Პრობლემები რომელიც უმეტესად მოიცავდა
            დაავადებების და ტკიპის აღმოჩენას და მასთან ბრძოლას. Აქედან
            გამომდინარე ჩვენ გადავწყვიტეთ ჩვენი ტექნოლოგიური ცოდნითა და ჩვენი
            გამოცდილებით შეგვექმნა სტარტაპი რომელიც ორიენტირებული იქნებოდა ამ
            პროებლემის მოგვარებაზე. ასე დაიბადა Beetkar-ის იდეაა
          </p>
        </div>
